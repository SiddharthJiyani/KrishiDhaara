...
const Card = () => {
  return (
    <StyledWrapper>
      <div className="main_wrapper mx-auto flex flex-col items-center justify-center">
        ...
        C86.34,11.918,137.664-5.445,189.928,1.502l-3.95,29.738C143.041,25.54,100.895,39.789,70.343,70.343z" />
              ...
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen">
                    <span className="notfound_text">404 PAGE NOT FOUND !</span>
                  </div>
            ...
            <div className="buttons_div !z-50">
        ...
        <Link
          to="/"
          className=" mx-auto mt-6 px-6 py-3 bg-[#37986c] text-white rounded-lg hover:bg-[#2d6a4f] transition duration-300"
        >
          Go back to the farm! 🧑‍🌾
        </Link>
      </div>
...
const StyledWrapper = styled.div`
  ...
  .antenna_shadow {
    ...
    box-shadow:
      inset 0px 16px #2d6a4f,
      inset 0px 16px 1px 1px #2d6a4f;
    -moz-box-shadow:
      inset 0px 16px #2d6a4f,
      inset 0px 16px 1px 1px #2d6a4f;
  }
  ...
  .tv {
    ...
    box-shadow: inset 0.2em 0.2em #40916c;
  }
  .tv::after {
    content: "";
    position: absolute;
    ...
    border-radius: 15px;
    background:
      repeating-radial-gradient(#2d6a4f 0 0.0001%, #00000070 0 0.0002%) 50% 0/2500px
        2500px,
      repeating-conic-gradient(#2d6a4f 0 0.0001%, #00000070 0 0.0002%) 60% 60%/2500px
        2500px;
  ...
  .display_div {
    ...
    justify-content: center;
    border-radius: 15px;
    box-shadow: 3.5px 3.5px 0px #40916c;
  }
  .screen_out {
    width: auto;
    height: auto;
